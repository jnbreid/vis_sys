...
class Trainer:
    ...
    def train_one_step(self, items):
        ...
        loss = self.criterion(prediction_frames, output)
    ...
    def train(self):
        ...
        for i in progress_bar:
            ...
            if i % self.EVAL_FREQ == 0:
                valid_loss, geodesic, eulerangle, pck, positional = eval_model(self.model, self.valid_loader, self.criterion, self.device, input = self.input, loss_only = False)
                ...
                self.writer.add_scalar(f'positional', positional, global_step = i)
