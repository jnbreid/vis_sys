...
def mpjpe_error(pred,gt): 
    """
    mpjpe loss function, taken from 'https://github.com/MotionMLP/MotionMixer/blob/main/h36m/utils/utils_mixer.py'
    """
    ...
    return torch.mean(torch.norm(delta,p = 2, dim = 1))